/* =========================================================
   ...
   ⚠️ 본문 이관 관련 안내 (2026-06-30 확인)
     현재 꿈들.com 도메인(punycode: xn--cw0by0h.com)은 더 이상
     '교육성장네트워크 꿈들' 사이트를 서빙하지 않습니다.
     실제로는 '제주특별자치도철인3종협회' 사이트로 연결되어
     원본 게시글 본문을 라이브에서 가져올 수 없습니다.
     → 본문은 백업/아카이브 또는 보관본을 확보한 뒤 각 항목의 body에
        채워 넣어 주세요. 자세한 내용은 저장소 루트의 MIGRATION_NOTES.md 참고.
   ========================================================= */
